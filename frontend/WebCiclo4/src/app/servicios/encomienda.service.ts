  ...
  export class EncomiendaService {
    ...
    store(encomienda: EncomiendaModel): Observable<EncomiendaModel> {
      return this.http.post<EncomiendaModel>(`${environment.urlBackend}/encomiendas`, {
    ...
    getAll(): Observable<EncomiendaModel[]>{
      return this.http.get<EncomiendaModel[]>(`${environment.urlBackend}/encomiendas`, {
    ...
    update(encomienda: EncomiendaModel): Observable<EncomiendaModel> {
      return this.http.patch<EncomiendaModel>(`${environment.urlBackend}/encomiendas/${encomienda.id}`, {
        descripcion: encomienda.descripcion,
        peso: encomienda.peso,
        tipo: encomienda.tipo,
        presentacion: encomienda.presentacion
    ...
    delete(id: string): Observable<EncomiendaModel[]>{
      return this.http.delete<EncomiendaModel[]>(`${environment.urlBackend}/encomiendas/${id}`, {
        headers: new HttpHeaders({
          "Authorization": `Bearer ${this.token}`
        })
      });
    ...
    getWithId(id: string): Observable<EncomiendaModel>{
      return this.http.get<EncomiendaModel>(`${environment.urlBackend}/encomiendas/${id}`,{
        headers: new HttpHeaders({
          "Authorization": `Bearer ${this.token}`
        })
      });
    ...
    getCount(): Observable<EncomiendaModel[]>{
      return this.http.get<EncomiendaModel[]>(`${environment.urlBackend}/encomiendas/count`, {
        headers: new HttpHeaders({
          "Authorization": `Bearer ${this.token}`
        })
      });
